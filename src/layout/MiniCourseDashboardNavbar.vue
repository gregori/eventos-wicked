<template>
  <md-toolbar id="toolbar" md-elevation="0" class="md-static" :class="extraNavClasses">
        ...
        <div class="md-collapse">
          <div class="md-collapse-wrapper">
            ...
            <md-list>
              ...
              <md-list-item href="javascript:(0)" target="_blank" style="vertical-align: middle;">
                <router-link :to="{ name: 'minicourse.informations.index' }">
              ...
              <md-list-item href="javascript:(0)" target="_blank" style="vertical-align: middle;">
                <router-link :to="{ name: 'minicourse.categories.index' }">
